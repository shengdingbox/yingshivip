...
public class Mon {
    public static void setWhiteBar(Activity activity){
        if (Mon.StatusBarLightMode(activity) == true){
            //cn.m.cn.m.bdplayer.Mon.setStatusBarColor(activity, R.color.white);
    ...
    public static int setVolume(Context activity, boolean flag) {
        ...
        manager.setStreamVolume(AudioManager.STREAM_MUSIC, curretnV,AudioManager.FLAG_REMOVE_SOUND_AND_VIBRATE);
        return  curretnV;
    }
