...
public class IListView extends LinearLayout {
    ...
    public void setLayout(int ResId,int style){
        ...
        if (style == 2) {
            ...
            GridLayoutManager layoutManager = new GridLayoutManager(this.getContext(), spanCount);
            mRecycler.setLayoutManager(layoutManager);
        }else {
        ...
        if (isLoadMore){
            mAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
                ...
                public void onLoadMoreRequested() {
                    if (mListener != null) {
                        mListener.startLoadMore(mAdapter);
                    }
                }
            },mRecycler);
        }
