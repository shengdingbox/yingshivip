...
public class 文本 {
    public static String get中间文本(String text,int start,int length){
        return text.substring(start,length);
    }
    public static String get中间文本(String text,String left,String right){
    ...
    public static String get中间文本(String text,String left,String right,int start){
        String result = "";
        int zLen;
    ...
    public static String get中间文本(String text,int start,String right){
        String result = "";
    ...
    public static String get文本左边(String text,String t1){
        int ri;
    ...
    public static String get文本左边(String text,String t1,String t2){
        int ri;
        ri = text.indexOf(t1);
        String result = text.substring(0, ri) + t2;;
        return result;
    }
    public static String get文本左边(String text,int length){
    ...
    public static String get文本左边(String text,int length,String t2){
    ...
    public static String get文本右边(String text,int length){
        return text.substring(text.length() - length,text.length());
    }
    public static String get文本右边(String text,String t1){
        int ri;
    ...
    public static List<String> get中间文本集合(String text, String left, String right){
